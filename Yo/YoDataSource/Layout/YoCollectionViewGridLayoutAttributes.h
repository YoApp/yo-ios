...
@interface YoCollectionViewGridLayoutAttributes : UICollectionViewLayoutAttributes
...
@interface YoGridLayoutInvalidationContext : UICollectionViewLayoutInvalidationContext
