...
@implementation YoCollectionViewGridLayoutAttributes
...
{
    if (![object isKindOfClass:[YoCollectionViewGridLayoutAttributes class]])
        return NO;

    YoCollectionViewGridLayoutAttributes *other = object;
...
{
    YoCollectionViewGridLayoutAttributes *attributes = (YoCollectionViewGridLayoutAttributes *)[super copyWithZone:zone];
...
@implementation YoGridLayoutInvalidationContext
