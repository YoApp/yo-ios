...
extern CGFloat const YoRowHeightVariable;
...
extern CGFloat const YoRowHeightRemainder;

extern CGFloat const YoRowHeightDefault;

typedef UICollectionReusableView *(^YoLayoutSupplementaryItemCreationBlock)(UICollectionView *collectionView, NSString *kind, NSString *identifier, NSIndexPath *indexPath);
typedef void (^YoLayoutSupplementaryItemConfigurationBlock)(id view, id dataSource, NSIndexPath *indexPath);

/// Definition of how supplementary views should be created and presented in a collection view.
@interface YoLayoutSupplementaryMetrics : NSObject <NSCopying>
...
@property (nonatomic, copy) YoLayoutSupplementaryItemCreationBlock createView;
...
@property (nonatomic, copy) YoLayoutSupplementaryItemConfigurationBlock configureView;

@end

/// Definition of how a section within a collection view should be presented.
@interface YoLayoutSectionMetrics : NSObject <NSCopying>

/// The height of each row in the section. A value of YoRowHeightVariable will cause the layout to invoke -collectionView:sizeFittingSize:forItemAtIndexPath: on the data source for each cell. Sections will inherit a default value from the data source of 44.
